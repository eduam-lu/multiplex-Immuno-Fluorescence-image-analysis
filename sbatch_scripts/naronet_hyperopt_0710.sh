...
#
# job name
#SBATCH -J NaroNet_full_fixed_params_smaller
#
...
#SBATCH -o sbatch_outputs/NaroNet_full1_0710_%j.out
#SBATCH -e sbatch_outputs/NaroNet_full1_0710_%j.out
...
# The previous fixed model run, is not being accepted. I would love to have something as a proper result
# I do this smaller version (5 fold instead of 10) and requesting fewer resources
